class Roulette:
    def __init__(self, queue):
        self.BET_MSG = "Place your bets! Before all your bets, please type " \
                    + "'bet' followed by a space and the following:" \
                    ...
                    + "Place your what you're betting on followed by a space " \
    ...
    def run(users):
        for user in users:
            self.msgQueue.put(('send', user[0], self.BET_MSG))
