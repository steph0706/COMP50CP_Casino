...
class baccarat:
	...
	def bet(self, user, betsize, beton):
		""" 
		Saves what user betted on and how much into the dict of users in the class.
	...
	def bet_message(self):
		""" Returns the bet message for baccarat and a list of available options users can bet on. """
